        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session.getAttribute("UserObject") != null) {
                ...
                try {
                    ...
                    System.out.println("Post ID DeletPostServlet Error:" + ex.getMessage());
                }
                int rowAffected;
                try {
                    rowAffected = p.DeletePostMethod(PostId, p.getCode());
                    ...
                    System.err.println("DeletePost Servlet Error:" + ex.getMessage());
                    out.println("DeletePost Servlet Error:" + ex.getMessage());
