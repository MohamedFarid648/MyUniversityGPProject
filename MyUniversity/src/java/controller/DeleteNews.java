          ...
          HttpSession session = request.getSession();
            if (session.getAttribute("UserObject") != null) {
                ...
                try {
                    ...
                    PostId = Integer.parseInt(request.getParameter("NewsID"));
                    ...
                    System.out.println("Post ID DeletNewsServlet Error:" + ex.getMessage());
                }
                int rowAffected;
                try {
                    rowAffected = p.DeleteNewsMethod(PostId, p.getCode());
                    ...
                    if (rowAffected > 0) {
                      ...
                      //  out.println("<script type='text/javascript' > alert('Post was Adding Successfully  ^_^ ');history.back();</script>");
                        ...
                        out.println("<script type='text/javascript' > alert('Deleting Post is Failed ^_^ ');history.back();</script>");
                    }

                } catch (Exception ex) {
                    System.err.println("DeleteNews Servlet Error:" + ex.getMessage());
                    out.println("DeleteNews Servlet Error:" + ex.getMessage());
