...
<html>
    ...
    <body>
        ...
        <div id="rightcontentRigs">
            <br/>
            <font style="color: #905;font-size: x-large;">Users:</font>
            <br/>
            <table border="1">
                <thead>
                    <tr>
                ...
                <tbody>
                    <%
                        try {
                            ...
                            ResultSet result = modelOfUniversityAdmin.ViewMyFacylityAdmins(p.getUniversityID());
                            while (result.next()) {
                    %>
                    ...
                    <tr>
                        ...
                        <td>  <% if (result.getInt("UserTypeID") == 6) {
                            ...
                            } else if (result.getInt("UserTypeID") == 3) {
                                out.println("Faculity Admin");
                            }
                            %>
                        ...
                        <td><%= MyPerson.ReturnFaculityName(result.getInt("Code"))%></td>
                        <td>
