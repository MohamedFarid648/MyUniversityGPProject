...
$(document).ready(function() {
	...
	$("#nav > li").css({"display": "inline", "background-color": "#fff", "margin": "0 10px"});
	$("#nav > li > ul").css({"padding": "5px", "position": "absolute", "width": "auto"});
	$("#nav > li > ul > li").css({"color": "black", "height": "100%", "padding": "0 0 0 5px", "width": "120px"});
	...
	$("#nav li > ul").css({"background": "white", "border": "#fff solid 2px"});
	$("#nav ul ul").css({"background": "none", "border": "none"});
	$("#nav li > ul").css({"color": "#fff", "display": "block", "float": "left", "margin": 0, "padding": "10px", "left": "auto"});
